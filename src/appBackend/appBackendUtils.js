...
export const formatPaymentMethod = (method) =>
  ({ balance: "Balance", ewallet: "E-Wallet", credit_card: "Credit Card" })[
    method
  ] || method;
...
export const pickPalette = (seed) =>
  palette[Math.abs(Number(seed) || 0) % palette.length];
...
export const cloneArray = (items) => (Array.isArray(items) ? [...items] : []);
